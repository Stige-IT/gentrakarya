...
import AddImageGaleryPelatihan from "./add_image_galery"
...
const DetailPelatihan = () => {
    ...
    const handleDeleteImage = (imageId) => {
        deleteImageGaleryPelatihan(accessToken, imageId).then((response) => {
            console.log(response);
            getImagePelatihan(pelatihan_id).then((response) => {
                if (response && response.status === 200) {
    ...
    useEffect(() => {
        ...
        showPelatihan(accessToken, pelatihan_id).then((response) => {
            if (response && response.status === 200) {
                setData(response.data.data)
            } else {
                setData([])
        ...
        <>
            ...
            <Layout>
                ...
                <div className="w-full px-3 md:px-5 lg:px-10 py-5">
                    <p className="text-2xl font-semibold text-center uppercase bg-gray-300 py-2">{data?.judul_pelatihan}</p>
                    ...
                    <div className="w-full flex flex-col lg:flex-row lg:space-x-3 space-y-3 lg:space-y-0">
                        ...
                        <div className="w-full lg:w-[65%] space-y-3 md:space-y-0">
                            ...
                            <TemplateTextMagang name="Judul Pelatihan" value={data?.judul_pelatihan}></TemplateTextMagang>
                            <TemplateTextMagang name="Biaya Pelatihan" value={data?.biaya_pelatihan}></TemplateTextMagang>
                            <TemplateTextMagang name="Metoda Pelatihan" value={data?.metoda}></TemplateTextMagang>
                    ...
                    <div className="w-full mt-5">
                        <p className="border-b-2 font-semibold">Detail Pelatihan :</p>
                    ...
                    <div className="w-full mt-5">
                        <div className="flex items-center justify-between bg-gray-300 py-2 px-3 mb-3">
                            <p className="font-semibold ">Galeri Pelatihan :</p>
                            <AddImageGaleryPelatihan pelatihan_id={pelatihan_id}></AddImageGaleryPelatihan>
                        </div>
