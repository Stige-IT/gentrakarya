...
import { postImageGaleryPelatihan } from "../../../services/image_pelatihan_service";

const AddImageGaleryPelatihan = ({ pelatihan_id }) => {
    ...
    const handleSubmit = (e) => {
        ...
        postImageGaleryPelatihan(accessToken, pelatihan_id, images).then((response) => {
    ...
    return (
        <>
            ...
            <Modal show={openModal} onClose={() => setOpenModal(false)}>
                <Modal.Header>Tambah Galery Pelatihan/Modal.Header</Modal.Header>
...
export default AddImageGaleryPelatihan