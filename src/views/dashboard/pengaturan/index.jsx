...
const PengaturanD = () => {
  ...
  const fetchDataProfile = async (accessToken) => {
    try {
  ...
  useEffect(() => {
    ...
    if (accessToken === "" || accessToken === null) {
      ...
      fetchDataProfile(accessToken);

      const registrationCategory = localStorage.getItem(
        "registration_category"
      );

      if (registrationCategory === "LEMBAGA") {
        fetchDataProfileLembaga(accessToken);
      }
    }
  }, [navigate]);
      ...
      <Layout>
        ...
        <div className="accordion-group accordion-group-hover">
            ...
            <div className="accordion-content text-content2">
              <div className="pr-5 md:pr-5 md:pl-16 flex flex-col md:flex-row items-center justify-center space-x-3 py-2">
                <div className="w-full md:w-[40%]">
                  <div className="w-[70%] aspect-square rounded-xl bg-gray-400 relative overflow-hidden mx-auto shadow-md">
                    ...
                    <img
                      ...
                      alt="Foto Profil Pengguna Gentra Karya"
                ...
                <div class="w-full md:w-[60%]  py-4 flex flex-col space-y-3">
                  ...
                  ></TemplateInput>
                  <TemplateInput
                    name="Kategori Registrasi"
                    typeInput="text"
                    value={profile?.registration_category?.name}
                  ></TemplateInput>
                  {profile?.registration_sub_category === null ? (
                    ""
                  ) : (
                    <TemplateInput
                      name="Sub Kategori Registrasi"
                      typeInput="text"
                      value={profile?.registration_sub_category?.name ?? null}
                    ></TemplateInput>
                  )}
                </div>
              </div>
          ...
          <div className="accordion">
            ...
            <label htmlFor="toggle-6" className="accordion-title">
              Toggle Accordion 2
            </label>
              ...
              <div className="px-5 md:pr-5 md:pl-16 flex flex-col md:flex-row md:space-x-3 space-y-3 md:space-y-0">
                <div className="w-full md:w-1/2 py-4 space-y-3">
                  <div className="w-1/2 aspect-video rounded-xl bg-gray-400 mx-auto overflow-hidden border shadow-md relative">
                    {profileLembaga?.image === null ? (
                      ""
                    ) : (
                      <img
                        src={BaseURL + profileLembaga?.image}
                        alt="Profile Lembaga - Gentra Karya"
                  ...
                  ></TemplateInput>
                  <TemplateInput
                    name="Nama Penanggun Jawab"
                    value={profileLembaga?.nama_penanggung_jawab}
                    typeInput="text"
                    disabled={true}
                  ></TemplateInput>
                  <TemplateInput
                    name="No Telepon"
                    subName="( terdapat pada akun )"
                    value={profileLembaga?.no_telepon}
                    typeInput="text"
                    disabled={true}
                  ></TemplateInput>
                  <TemplateInput
                ...
                <div class="py-4 flex flex-col space-y-3 w-full md:w-1/2">
                  <div>
                    ...
                    <select
                      className="w-full py-2 focus:border-yellow-400 border-2 rounded-md outline-none"
                      disabled
                    >
                      <option value="0">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="" className="font-semibold">
                      Link Google Map (Opsional)
                    </label>
                    <a
                      href={profile?.address?.map}
                      target="_blank"
