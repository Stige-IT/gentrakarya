...
import { postImageGaleryMagang } from "../../../services/image_magang_service";

const AddImageGaleryMagang = ({ magang_id }) => {
    ...
    const handleSubmit = (e) => {
        ...
        postImageGaleryMagang(accessToken, magang_id, images).then((response) => {
    ...
    return (
        <>
            ...
            <Modal show={openModal} onClose={() => setOpenModal(false)}>
                <Modal.Header>Tambah Galery Magang</Modal.Header>
...
export default AddImageGaleryMagang