...
import { postImageGalerySertifikasi } from "../../../services/image_sertifikasi_service";

const AddImageGalerySertifikasi = ({ sertifikasi_id }) => {
    ...
    const handleSubmit = (e) => {
        ...
        postImageGalerySertifikasi(accessToken, sertifikasi_id, images).then((response) => {
    ...
    return (
        <>
            ...
            <Modal show={openModal} onClose={() => setOpenModal(false)}>
                <Modal.Header>Tambah Galery Sertifikasi/Modal.Header</Modal.Header>
...
export default AddImageGalerySertifikasi