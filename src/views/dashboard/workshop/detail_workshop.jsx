...
import AddImageGaleryWorkshop from "./add_image_galery"
...
const DetailWorkshop = () => {
    ...
    const handleDeleteImage = (imageId) => {
        deleteImageGaleryWorkshop(accessToken, imageId).then((response) => {
            console.log(response);
    ...
    useEffect(() => {
        ...
        showWorkshop(accessToken, workshop_id).then((response) => {
            if (response && response.status === 200) {
                setData(response.data.data)
            } else {
                setData([])
        ...
        <>
            ...
            <Layout>
                ...
                <div className="w-full px-3 md:px-5 lg:px-10 py-5">
                    <p className="text-2xl font-semibold text-center uppercase bg-gray-300 py-2">{data?.judul_workshop}</p>
                    ...
                    <div className="w-full flex flex-col lg:flex-row lg:space-x-3 space-y-3 lg:space-y-0">
                        ...
                        <div className="w-full lg:w-[65%] space-y-3 md:space-y-0">
                            ...
                            <TemplateTextMagang name="Judul Workshop" value={data?.judul_workshop}></TemplateTextMagang>
                            <TemplateTextMagang name="Biaya Workshop" value={data?.biaya_workshop}></TemplateTextMagang>
                            <TemplateTextMagang name="Metoda Workshop" value={data?.metoda}></TemplateTextMagang>
                    ...
                    <div className="w-full mt-5">
                        <div className="flex items-center justify-between bg-gray-300 py-2 px-3 mb-3">
                            ...
                            <AddImageGaleryWorkshop workshop_id={workshop_id}></AddImageGaleryWorkshop>
                        </div>
