...
const ListLamaranLembaga = () => {
    ...
    const handleTabs = (status) => {
        ...
        getLamaranLembaga(accessToken, status).then((response) => {
    ...
    useEffect(() => {
        ...
        getLamaranLembaga(accessToken, statusLamaran).then((response) => {
            if (response && response.status === 200) {
                setLamaran(response.data.data)
                setTotalLamaran(response.data.meta.total)
            } else {
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="text-sm bg-gray-400">
                                ...
                                <th className="px-3 py-2" >Statu Lamaran</th>
                            </tr>
                        </thead>
                        <tbody>
                            {lamaran?.map((itemm) => (
...
export default ListLamaranLembaga