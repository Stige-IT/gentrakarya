...
import { getWorkshopGeneralSample } from "../../../services/workshop_service";
...
const SampleWorkshop = () => {
    ...
    useEffect(() => {
        getWorkshopGeneralSample().then((response) => {
        ...
        <>
            <div className="w-full py-10 px-5 lg:px-10 ">
                <div className="flex justify-between">
                    <Title name="Info Workshop"></Title>
                    <a href="/workshop" className="text-black bg-custom-yellow px-3 py-2 rounded-md font-semibold">Lihat Semua</a>
                </div>
