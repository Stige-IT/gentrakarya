...
const DetailMagang = () => {
  ...
  return (
    <>
      ...
      <div className="h-screen w-full bg-white overflow-auto scrollbar-thin scrollbar-track-rounded-full  scrollbar-thumb-rounded-full scrollbar-thumb-yellow-400 text-black">
        <Navbar></Navbar>
