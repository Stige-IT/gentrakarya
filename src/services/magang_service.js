...
export const getMagangGeneral = async (province_id, regency_id, district_id, village_id) => {
    try {
        const response = await apiService.get(`magang?province_id=${province_id === 0 ? null : province_id}&regency_id=${regency_id === 0 ? null : regency_id}&district_id=${district_id === 0 ? null : district_id}&village_id=${village_id === 0 ? null : village_id}`, {
            headers: {
